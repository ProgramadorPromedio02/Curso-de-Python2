...
"""
Probando los comentarios con las comillas dobles.
"""
...
# type(): Devuelve el tipo de dato almacenado.
print("Viendo tipos de datos:")
print(type(3)) # Tipo 'int' 
print(type(3.5)) # Tipo 'float'
